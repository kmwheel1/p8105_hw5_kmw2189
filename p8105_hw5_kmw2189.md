...
The control group appears to have values that stay relatively constant
over time, while the experimental group appears to have values that
increase over the 8 week period.
...
Is the sample average of β^1 across tests for which the null is rejected
approximately equal to the true value of β1? Why or why not? WRITE TEXT
HERE
